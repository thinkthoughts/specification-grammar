...
3. **DEV_NOTES.md** — the repository's original internal conventions and rendering-era material: the five-line "Engineering SVG" reference chain and the artifact-naming conventions (RO/ES/NB/SR/ER) this repository's naming already followed before SG_0001 existed. Read this as historical/internal context, not as the external pressure test for SG_0001.
